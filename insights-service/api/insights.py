...
@router.get("/{user_id}/categories", response_model=dict)
...
@router.get("/{user_id}/budget", response_model=dict)
...
@router.get("/{user_id}/bills", response_model=dict)
...
@router.get("/{user_id}/anomalies", response_model=dict)
