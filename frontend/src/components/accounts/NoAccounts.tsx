...
export const NoAccounts: React.FC<NoAccountsProps> = ({
  accounts,
  setAccounts,
}) => {
  return (
    <div className="w-11/12 md:w-10/12 lg:w-7/12 2xl:w-6/12 my-8 mx-auto flex flex-col space-y-3">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Start managing your finances by adding your accounts
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">
              Track your finances by adding your bank accounts, credit cards,
