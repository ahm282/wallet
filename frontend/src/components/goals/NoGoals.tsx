    ...
    <div className="w-11/12 md:w-10/12 lg:w-7/12 2xl:w-6/12 my-8 mx-auto flex flex-col space-y-3">
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">
              Setting financial goals helps you stay motivated and track your
              progress towards important milestones.&nbsp;&nbsp;🚀
            </p>
          </div>
          <AddGoalDialog goals={goals} setGoals={setGoals}></AddGoalDialog>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Read our guide to get started and discover strategies for setting
            your goals.
          </CardDescription>
        </CardHeader>
        <CardContent>
