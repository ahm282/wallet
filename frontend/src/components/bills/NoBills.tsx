...
export const NoBills: React.FC<NoBillsProps> = ({ bills, setBills }) => {
  return (
    <div className="w-11/12 md:w-10/12 lg:w-7/12 2xl:w-6/12 my-8 mx-auto flex flex-col space-y-3">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Start tracking your bills to stay on top of your expenses
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">
              Managing your bills helps you avoid late payments and maintain a
              healthy financial status.&nbsp;&nbsp;📝
            </p>
          </div>
          <AddBillDialog bills={bills} setBills={setBills}></AddBillDialog>
        </CardContent>
      </Card>
