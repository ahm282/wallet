...
export const BillsDashboard: React.FC<BillsDashboardProps> = ({ bills }) => {
  ...
  const upcomingBills = bills.filter(
    (bill) => new Date(bill.dueDate) >= now && !bill.paid,
  );
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl font-bold flex items-center">
              <LucideCalendarDays className="mr-2 h-6 w-6 text-primary" />
              Upcoming Bills
            </CardTitle>
          </CardHeader>
          <CardContent>
