  ...
  return (
    <div className="md:w-10/12 lg:w-7/12 2xl:w-6/12 my-8 mx-auto flex flex-col space-y-7">
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground mb-6">
            Let's get started with setting up your account. Here are some steps
            to help you begin:
          </p>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground mb-6">
            Check out your profile to see your account details and recent
            activities.
          </p>
          <Link to="/profile">
            <Button>
...
const MobileLayout: React.FC = () => {
  return (
    <div className="w-10/12 mx-auto my-8">
      <div id="introduction" className="py-4 space-y-3">
