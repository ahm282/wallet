...
export const MonthlySpendingTrendGraph = ({ data }: { data: Record<string, number> }) => {
                ...
                <ResponsiveContainer
                    ...
                    <BarChart
                        ...
                        <Tooltip
                            ...
                            formatter={(value: number) => [`${currencyNotation(value).toLocaleString()}`, "Spent"]}
...
export default MonthlySpendingTrendGraph;
