...
export const EditBudgetDialog: React.FC<EditBudgetDialogProps> = ({
  ...
  const [editedBudget, setEditedBudget] = useState<EditedBudgetForm | null>(
    null,
  );
          ...
          <div className="w-11/12 grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3">
                ...
                />
                {errors.budgeted && (
                  <p className="text-xs text-red-500">{errors.budgeted}</p>
                )}
              </div>
            </div>
            {/* Spent Field */}
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3">
                ...
                />
                {errors.spent && (
                  <p className="text-xs text-red-500">{errors.spent}</p>
                )}
              </div>
            </div>
          </div>
